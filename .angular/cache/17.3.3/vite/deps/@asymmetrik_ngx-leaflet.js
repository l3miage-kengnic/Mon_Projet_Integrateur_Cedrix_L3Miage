...
import {
  ...
  ɵɵlistener,
  ɵɵresolveWindow
} from "./chunk-3DCIIU3R.js";
import "./chunk-E2H5IIOR.js";
import {
  __toESM
} from "./chunk-SJQFV65P.js";
...
_LeafletDirective.ɵfac = function LeafletDirective_Factory(t) {
  return new (t || _LeafletDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
};
_LeafletDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    fitBoundsOptions: [InputFlags.None, "leafletFitBoundsOptions", "fitBoundsOptions"],
    panOptions: [InputFlags.None, "leafletPanOptions", "panOptions"],
    zoomOptions: [InputFlags.None, "leafletZoomOptions", "zoomOptions"],
    zoomPanOptions: [InputFlags.None, "leafletZoomPanOptions", "zoomPanOptions"],
    options: [InputFlags.None, "leafletOptions", "options"],
    zoom: [InputFlags.None, "leafletZoom", "zoom"],
    center: [InputFlags.None, "leafletCenter", "center"],
    fitBounds: [InputFlags.None, "leafletFitBounds", "fitBounds"],
    maxBounds: [InputFlags.None, "leafletMaxBounds", "maxBounds"],
    minZoom: [InputFlags.None, "leafletMinZoom", "minZoom"],
    maxZoom: [InputFlags.None, "leafletMaxZoom", "maxZoom"]
  },
  outputs: {
...
_LeafletLayerDirective.ɵfac = function LeafletLayerDirective_Factory(t) {
  return new (t || _LeafletLayerDirective)(ɵɵdirectiveInject(LeafletDirective), ɵɵdirectiveInject(NgZone));
};
_LeafletLayerDirective.ɵdir = ɵɵdefineDirective({
  type: _LeafletLayerDirective,
  selectors: [["", "leafletLayer", ""]],
  inputs: {
    layer: [InputFlags.None, "leafletLayer", "layer"]
  },
  outputs: {
...
_LeafletLayersDirective.ɵfac = function LeafletLayersDirective_Factory(t) {
  return new (t || _LeafletLayersDirective)(ɵɵdirectiveInject(LeafletDirective), ɵɵdirectiveInject(IterableDiffers), ɵɵdirectiveInject(NgZone));
};
_LeafletLayersDirective.ɵdir = ɵɵdefineDirective({
  type: _LeafletLayersDirective,
  selectors: [["", "leafletLayers", ""]],
  inputs: {
    layers: [InputFlags.None, "leafletLayers", "layers"]
  }
});
...
_LeafletLayersControlDirective.ɵfac = function LeafletLayersControlDirective_Factory(t) {
  return new (t || _LeafletLayersControlDirective)(ɵɵdirectiveInject(LeafletDirective), ɵɵdirectiveInject(KeyValueDiffers), ɵɵdirectiveInject(NgZone));
};
_LeafletLayersControlDirective.ɵdir = ɵɵdefineDirective({
  type: _LeafletLayersControlDirective,
  selectors: [["", "leafletLayersControl", ""]],
  inputs: {
    layersControlConfig: [InputFlags.None, "leafletLayersControl", "layersControlConfig"],
    layersControlOptions: [InputFlags.None, "leafletLayersControlOptions", "layersControlOptions"]
  },
  outputs: {
...
_LeafletBaseLayersDirective.ɵfac = function LeafletBaseLayersDirective_Factory(t) {
  return new (t || _LeafletBaseLayersDirective)(ɵɵdirectiveInject(LeafletDirective), ɵɵdirectiveInject(KeyValueDiffers), ɵɵdirectiveInject(NgZone));
};
_LeafletBaseLayersDirective.ɵdir = ɵɵdefineDirective({
  type: _LeafletBaseLayersDirective,
  selectors: [["", "leafletBaseLayers", ""]],
  inputs: {
    baseLayers: [InputFlags.None, "leafletBaseLayers", "baseLayers"],
    layersControlOptions: [InputFlags.None, "leafletLayersControlOptions", "layersControlOptions"]
  },
  outputs: {
    layersControlReady: "leafletLayersControlReady"
...
_LeafletModule.ɵfac = function LeafletModule_Factory(t) {
  return new (t || _LeafletModule)();
};
...
//# sourceMappingURL=@asymmetrik_ngx-leaflet.js.map
